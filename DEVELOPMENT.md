...
```bash
git remote add encore encore://gripah-landing-page-7wr2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/gripah-landing-page-7wr2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/gripah-landing-page-7wr2/settings/integrations/github)

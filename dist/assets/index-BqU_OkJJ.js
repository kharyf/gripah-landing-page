...
const Apple = createLucideIcon("apple", __iconNode$5);
/**
 * @license lucide-react v0.484.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-black text-lime-500", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-6 py-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/gripah-logo.png", alt: "Gripah", className: "h-24 mx-auto mb-6" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "text-center py-12 px-6 border-t border-lime-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lime-500/60 text-sm", children: "© 2026 Gripah. All rights reserved." }) })
  ] });
}
function FeatureCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black border border-lime-500/30 rounded-xl p-6 hover:border-lime-500/60 transition-colors duration-200", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lime-400 mb-4", children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-3 text-lime-400", children: title }),
